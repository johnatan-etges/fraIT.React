...
export const CARD_BORDER_SHADOW = theme('mode', {
    light: LIGHT_CARD_HEADER_BORDER_SHADOW,
...
export const CARD_BORDER_SHADOW_SIZES = theme('mode', {
    light: LIGHT_CARD_BORDER_SHADOW_SIZES,
    dark: '',
});