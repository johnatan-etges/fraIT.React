...
import { DARK_HEADER_BACKGROUND , DARK_BODY_CARD_BACKGROUND, DARK_CARD_BACKGROUND, DARK_CARD_TITLE, DARK_CARD_SUBTITLE, DARK_CARD_PARAGRAPH, DARK_CARD_BORDER, DARK_CARD_BORDER_HOVER, DARK_CARD_HEADER_BORDER, DARK_CARD_HEADER_BORDER_HOVER, DARK_CARD_BORDER_SHADOW, DARK_CARD_OPACITY, DARK_CARD_BORDER_SHADOW_HOVER} from '../styles/themes/dark';
import { LIGHT_HEADER_BACKGROUND, LIGHT_BODY_CARD_BACKGROUND, LIGHT_CARD_TITLE, LIGHT_CARD_SUBTITLE, LIGHT_CARD_PARAGRAPH, LIGHT_CARD_BORDER, LIGHT_CARD_HEADER_BORDER, LIGHT_CARD_BORDER_SHADOW, LIGHT_CARD_HEADER_BORDER_HOVER, LIGHT_CARD_BORDER_HOVER, LIGHT_CARD_BACKGROUND, LIGHT_CARD_OPACITY, LIGHT_CARD_BORDER_SHADOW_HOVER } from './themes/light';
...
export const CARD_BORDER_SHADOW_HOVER = theme('mode', {
    light: LIGHT_CARD_BORDER_SHADOW_HOVER,
    dark: DARK_CARD_BORDER_SHADOW_HOVER
})